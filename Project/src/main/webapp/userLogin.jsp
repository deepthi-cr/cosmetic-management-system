...
<head>
    ...
    <title>User Login - GlamourCosmetics</title>
    <!-- Bootstrap CSS -->
    ...
    <style>
        ...
        .login-left {
            background: linear-gradient(rgba(212, 165, 192, 0.9), rgba(192, 108, 132, 0.9)),
                        url('https://images.unsplash.com/photo-1596462502278-27bfdc403348?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80');
            ...
            <div class="row g-0">
                <div class="col-lg-6">
                    <div class="login-left">
                        <h2>Welcome Back to Beauty</h2>
                        <p>Sign in to your account to manage your cosmetics business and access exclusive features.</p>

                        <ul class="benefits-list">
                            <li>
                                <i class="fas fa-check"></i>
                                <span>Access your product inventory</span>
                            </li>
                            <li>
                                <i class="fas fa-check"></i>
                                <span>View sales analytics and reports</span>
                            </li>
                            <li>
                                <i class="fas fa-check"></i>
                    ...
                    <div class="login-right">
                        ...
                        <form action="userLogin" method="post">
                            ...
                            <div class="register-link">
                                Don't have an account? <a href="redirectToRegister">Create one here</a>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 mb-4">
                    ...
                    <div class="footer-links">
                        <a href="#">Inventory Managemen  t</a>
